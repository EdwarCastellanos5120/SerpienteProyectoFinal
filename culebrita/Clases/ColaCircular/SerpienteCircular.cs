...
{
    internal class SerpienteCircular
    {
        ...
        {
            Console.Title = "JUEGO DE LA SERPIENTE - CIRCULAR";
        ...
        private static bool MoverLaCulebrita(ColaCircular serpiente, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            ...
            // Quitar cola
            if (serpiente.TamanioCola() > longitudCulebra)
            {
        ...
        private static Point MostrarComida(Size screenSize, ColaCircular serpiente)
        {
