...
namespace SerpienteProyecto.Clases.ColaArrayList
{
    internal class SerpienteArray
    {
        ...
        {
            Console.Title = "JUEGO DE LA SERPIENTE - ARREGLO";
        ...
        private static bool MoverLaCulebrita(ColaArrayList serpiente, Point posiciónObjetivo,
        ...
        private static Point MostrarComida(Size screenSize, ColaArrayList serpiente)
        {
